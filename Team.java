...
public class Team {
    ...
    /***********************************************************************
    Name: Team
    Parameters: String teamId, String teamName, String principal, String location, int championships, int totalPoints
    Purpose: To create a Team object with the given parameters
    ***********************************************************************/
    public Team(public String teamId, String teamName, String principal, String location, int championships, int totalPoints) {
        this.teamId = teamId;
    ...
    Name: getTeamId
    Parameters: none
    Purpose: To get the teamId of the Team object
    ***********************************************************************/
    ...
    ************************************************************************/
    ...
    public String toString() {
        return teamName + " - Principal: " + principal + ", Location: " + location + ", Championships: " + championships + ", Total Points: " + totalPoints;
    }
